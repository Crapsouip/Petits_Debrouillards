/*	MyMagicStick v_1.0
	Fichier de fonction Systeme Global
...
///////////////////////////////CONSTRUCTEURS///////////////////////////////////
///////////////////////////////////////////////////////////////////////////////	
MyMagicStick::MyMagicStick()
{}

void MyMagicStick::begin(uint8_t RxD, uint8_t TxD, uint8_t MoisturePin, uint8_t LumPin, uint8_t TempPin)
{
//Initialisation:	
	//Générale:
...
void MyMagicStick::beginMoist(uint8_t RxD, uint8_t TxD, uint8_t MoisturePin)
{
	//Initialisation:	
	//Générale:
	ReceivedBuffer.reserve(32);
...
void MyMagicStick::beginTemp(uint8_t RxD, uint8_t TxD, uint8_t TempPin)
{
	//Initialisation:	
	//Générale:
	ReceivedBuffer.reserve(32);
...
/////////////////////////////////COMMUNICATION/////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void MyMagicStick::setupBTconnection(uint8_t RxD, uint8_t TxD)
{
	Serial.print(F("Initialisation MyMagicStick\n"));
	pinMode(RxD, INPUT);
	pinMode(TxD, OUTPUT);
	...
	delay(2000);
	(*BTModule).print("\r\n+INQ=1\r\n");
	Serial.print("MyMagicStick ready !!!\n");
	delay(2000);
	(*BTModule).flush();
}
///////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////FONCTION DIY//////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void MyMagicStick::getTemperature()
{
//Mesure:
...
void MyMagicStick::getTemperatureR()
{
	if(!IsDHTHere)
	{
	//Mesure:	
...
void MyMagicStick::getLuminosity()
{
//Mesure:
	Capteur_L.readData();
//Ecriture:
...
void MyMagicStick::getLuminosityR()
{
//Mesure:
	Capteur_L.readRVal();
//Ecriture:
...
void MyMagicStick::getLuminosityB()
{
//Mesure:
...
////////////////////////////////FONCTION STICK/////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void MyMagicStick::checkMessage()
{
	ReceivedBuffer = "";
	ReceivedBuffer = myRead(*BTModule);
}

void MyMagicStick::treatMessage()
{
...
void MyMagicStick::mountMessage()
{
	switch(MessageLevel)
	{
		case 5:			//General
